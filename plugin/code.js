...
(() => {
  ...
  function buildPluginCoverage({ gapfill, capture: capture2, perf }) {
    ...
    return sessionCoverage([
      ...
      coverageRow("capture-errors", capture2?.errorCount ?? 0, "status.captureErrors"),
  ...
  var RAIL_MIN_WIDTH = 240;
  var RAIL_MAX_WIDTH = 560;
  var RAIL_HEIGHT = 44;
  function clampRailWidth(requested) {
  ...
  function resolveViewportRequest(message) {
